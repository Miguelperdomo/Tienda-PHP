...
$sql="SELECT  * from cliente  where id_cliente=:co";//consulta con marcador, el marcador es :codigo
...
$resultado->execute(array(":co"=>$busca));
	...
	if($registro=$resultado->fetch(PDO::FETCH_ASSOC)){
		...
		?>
		<form action="./validaeli.php" method="get">
		...
		<table border="2" class="principal">
            ...
            <tr>
				...
				<td class="titulo">
					<input type="text"  class="in" readonly name="doc" value="<?php echo $registro['id_cliente']?>">
				</td>
			</tr>
			
            <tr>
				<th class="ti"> Nombre del Cliente </th>
				<td class="titulo">
					<input type="text"  class="in" name="nom" value="<?php echo $registro['nombre_cliente']?>">
				</td>
			</tr>
			
            <tr>
				<th class="ti"> Apellido del Cliente </th>
				<td class="titulo">
					<input type="text"  class="in" name="ape" value="<?php echo $registro['apellido_cliente']?>">
				</td>
			</tr>
