...
$sql="SELECT  * from cliente  where id_cliente=:id";//consulta con marcador, el marcador es :codigo
...
$resultado->execute(array(":id"=>$busca));
	...
	if($registro=$resultado->fetch(PDO::FETCH_ASSOC)){
		...
		<table border="2" class="principal">
            ...
            <tr>
				<th class="ti"> Apellido Cliente </th>
				<td  class="titulo">
