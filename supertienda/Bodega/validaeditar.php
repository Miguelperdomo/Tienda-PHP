...
$resultado->execute(array(":ir"=>$codigo, ":cod"=>$codigo,":nom"=>$nombre,":pre"=>$precio, ":exi"=>$exis));//asigno las variables a los marcadores
echo '<script>alert("Haz actualizado nuestra Base de Datos, Yuju!");</script>';
echo '<script>window.location= "verproductos.php"</script>';
